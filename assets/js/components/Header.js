...
export function Header({ copy, nav, language, onLanguageChange }) {
  return html`<header className="site-header" id="top">
    <div className="site-header__inner">
      <div className="site-header__brand">
        <span className="site-header__logo" aria-hidden="true">AKCSE</span>
      ...
      <div className="site-header__controls">
        <nav className="site-header__nav" aria-label="Primary">
          <ul>
            ...
            <li><a href="#executive">${nav.executive}</a></li>
